...
export class InventarioComponent implements OnInit {
  ...
  // Pagination helpers
  paginationHistoricoPeriodos = new PaginationHelper<HistoricoPeriodo>(
    [10, 20, 30],
    10,
  );
  paginationHistoricoReestock = new PaginationHelper<MovimientoDetalle>(
    [30, 50, 100],
    30,
  );
  paginationHistoricoVentas = new PaginationHelper<MovimientoDetalle>(
    [25, 50, 100],
    25,
  );
